            ...
            <div className="flex flex-col items-center justify-between gap-6">
              ...
              <div className="flex items-center gap-3 w-full justify-center">
                <div className="flex items-center p-1.5 bg-muted rounded-xl border border-border/40 shadow-sm w-full md:w-auto justify-between md:justify-start">
                  <Button size="icon" variant="ghost" onClick={goToFirst} disabled={currentRecord === 1} className="h-9 w-9 hover:bg-white rounded-lg">
                    <ChevronsLeft className="h-4 w-4 text-pmpa-navy" />
                  </Button>
                  <Button size="icon" variant="ghost" onClick={goToPrevious} disabled={currentRecord === 1} className="h-9 w-9 hover:bg-white rounded-lg">
                  ...
                  <Button size="icon" variant="ghost" onClick={goToNext} disabled={currentRecord === totalRecords} className="h-9 w-9 hover:bg-white rounded-lg">
                    <ChevronRight className="h-4 w-4 text-pmpa-navy" />
                  </Button>
                  <Button size="icon" variant="ghost" onClick={goToLast} disabled={currentRecord === totalRecords} className="h-9 w-9 hover:bg-white rounded-lg">
