    ...
    <div className="space-y-6">
      <div className="bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl rounded-2xl p-4 md:p-6 border border-slate-200/50 dark:border-white/10 shadow-[0_10px_40px_rgba(0,0,0,0.06)] mb-8 transition-all group">
            ...
            <div className="flex justify-between items-center px-1">
              ...
              {selectedUnidade && (
                <button 
                  ...
                  className="text-[10px] font-bold text-red-500 hover:text-red-700 uppercase transition-colors flex items-center gap-1"
                >
                  <X className="h-3 w-3" />
                  Limpar
                </button>
          ...
          <div className="relative flex-1 group/input flex flex-col justify-end">
            <div className="flex justify-between items-center px-1 mb-2 md:hidden">
              <label className="text-[11px] font-black text-slate-500 uppercase tracking-widest">Busca Rápida</label>
            </div>
            <div className="relative">
              ...
              <Input
                ...
                className="pl-14 pr-16 h-12 md:h-14 text-base font-medium border-slate-200 dark:border-slate-700 focus-visible:ring-2 focus-visible:ring-[#004e9a]/50 focus-visible:border-[#004e9a] shadow-inner w-full rounded-xl bg-slate-50 dark:bg-slate-800 transition-all text-slate-800 dark:text-slate-100 placeholder:text-slate-400"
              />
              <Select value={filterType} onValueChange={setFilterType}>
                <SelectTrigger className="absolute right-2 top-1/2 -translate-y-1/2 h-10 w-10 md:h-12 md:w-12 p-0 flex items-center justify-center border-none bg-transparent hover:bg-slate-200 dark:hover:bg-slate-700/50 focus:ring-0 shadow-none transition-colors rounded-lg group-hover:text-[#004e9a]">
