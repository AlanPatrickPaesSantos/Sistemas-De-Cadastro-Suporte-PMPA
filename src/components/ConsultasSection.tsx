...
export const ConsultasSection = () => {
  ...
  return (
    <div className="h-full flex flex-col space-y-6">
      <div className="flex-1 bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-100 dark:border-slate-800 shadow-sm flex flex-col justify-center transition-all group">
        <div className="relative group/input">
          <div className="flex items-center gap-3 mb-6 text-slate-400">
            <Search className="w-5 h-5" />
            <span className="text-xs font-bold uppercase tracking-widest">Busca Rápida</span>
          </div>
