...
export const MissaoPrint = ({ data }: { data: MissaoData }) => {
  ...
  return createPortal(
    <div id="printable-mission" className="hidden print:block bg-white text-black min-h-screen font-sans">
      ...
      <div className="mx-auto w-full max-w-[210mm] border-2 border-black p-8">
        {/* Cabeçalho Oficial */}
        <div className="flex justify-between items-start mb-6 border-b-2 border-black pb-4">
          <div className="w-24">
            <img src="/logo-pmpa.png" alt="Logo PMPA" style={{ height: '70px', width: 'auto', objectFit: 'contain' }} />
          </div>
          <div className="text-center flex-1 font-bold uppercase text-[9px] space-y-0.5">
            ...
            <p className="text-[11px] mt-1 font-black underline">DIRETORIA DE TELEMÁTICA</p>
          </div>
          <div className="w-24 flex justify-end">
            <img src="/Logo Ditel.jpeg" alt="Logo Ditel" style={{ height: '70px', width: 'auto', objectFit: 'contain' }} />
          </div>
        </div>

        <h1 className="text-center text-lg font-black uppercase mb-6 underline tracking-widest">Ordem de Serviço</h1>
        ...
        <div className="space-y-4 mb-6">
          ...
          <div className="border border-black p-2 bg-gray-50/20">
             <div className="flex justify-between items-center px-4 py-1">
                ...
                <span className="text-[10px] font-black uppercase">HORÁRIO: <span className="font-bold underline ml-2">{data.horario || '__:__'}</span></span>
             </div>
          </div>
          ...
          <div className="grid grid-cols-2 border border-black divide-x divide-black">
            ...
            <div className="p-2">
              ...
              <span className="text-xs font-bold uppercase">{data.secao || 'SUPORTE'}</span>
            </div>
          </div>
        </div>
        ...
        <div className="mb-6">
          ...
          <div className="border border-black border-t-0 p-3 min-h-[140px]">
            <p className="text-[9px] font-black uppercase mb-2">Defeito Reclamado / Constatado:</p>
            <p className="text-[12px] leading-relaxed whitespace-pre-wrap">{data.def_recla || 'CONFORME SOLICITADO.'}</p>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="border border-black border-t-0 p-3 min-h-[180px]">
        ...
        {/* Observações - If any */}
        {data.observacao && (
          <div className="mb-8 border-2 border-black border-dashed p-2">
        ...
        {/* Assinaturas - Placed at the bottom */}
        <div className="grid grid-cols-2 gap-20 mt-12 py-8 text-center uppercase">
